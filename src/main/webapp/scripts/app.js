...
var panderaappApp = angular.module('panderaappApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'panderaappAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
